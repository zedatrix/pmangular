...
.controller('HomeController', function ($scope, $localStorage){
    ...
    if( ! $scope.authenticated() ){
        ...
        $scope.WelcomeMessage = 'Welcome to pmAngular. You need to log in with your ProcessMaker account in order to continue.';
